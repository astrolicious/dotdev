...
This thought piece clarifies **_my_** personal view and opinion. It is not meant to represent the opinion of every Astrolious member, but our vision is based on top of it. So we ask our members with a role, to stand behind it.
