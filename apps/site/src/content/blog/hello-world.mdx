...
<Wrapper title={frontmatter.title} activeTab='blog'>
  <article class="prose text-center mx-auto my-8">
    ...
    **Our mission?** 
    ...
    <CreativeCommon title="Hello World, from Astrolicious" titleUrl="https://astrolicious.dev/blog/hello-world" author="Alexander Niebuhr" authorUrl="https://github.com/alexanderniebuhr" />
  </article>
</Wrapper>
